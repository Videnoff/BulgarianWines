    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    HomePageSlideId = table.Column<int>(type: "int", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SlideImages_HomePageSlides_HomePageSlideId",
                        column: x => x.HomePageSlideId,
                        principalTable: "HomePageSlides",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Wines_Availabilities_AvailabilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShoppingCartProduct_Wines_WineId",
                        column: x => x.WineId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WineId1 = table.Column<int>(type: "int", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WineOrders_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteProducts_WineId",
                table: "FavoriteProducts",
                column: "WineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomePageSlides_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartProduct_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartProduct_WineId",
                table: "ShoppingCartProduct",
                column: "WineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SlideImages_HomePageSlideId",
                table: "SlideImages",
                column: "HomePageSlideId");

            migrationBuilder.CreateIndex(
                name: "IX_SlideImages_IsDeleted",
                table: "SlideImages",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WineOrders_IsDeleted",
                table: "WineOrders",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_WineOrders_OrderId",
                table: "WineOrders",
                column: "OrderId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_FavoriteProducts_Wines_WineId",
                table: "FavoriteProducts",
                column: "WineId",
                principalTable: "Wines",
                principalColumn: "Id",
